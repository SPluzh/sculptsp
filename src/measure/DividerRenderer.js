...
class DividerRenderer {
  constructor(parentElement) {
    ...
    this._svg.setAttribute('id', 'divider-overlay');
  ...
  render(segments, pendingA, pendingB, camera, pixelRatio, mouseX, mouseY, hoveredSegment, hoveredVertexKey, divisions, useDistanceThickness) {
