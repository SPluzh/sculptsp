var TR = {
  ...
  // mesh
  meshTitle: 'Mesh',
  meshNbVertices: 'Points actifs: ',
  meshNbFaces: 'Points totaux: ',
  ...
  sculptTopologyDetail: 'Niveau de détail',
  sculptTopologyDecimate: 'Décimation (simplifier)',
